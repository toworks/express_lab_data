...
set SERVICE_NAME="express_lab_data"
set APP_PATH=C:\bin\language\perl\perl\bin\perl.exe
set APP_DIR=C:\bin\daemon\express_lab_data
set APP_PARAMETERS="express_lab_data.pl"
set APP_DISPLAYNAME="ArcelorMittal.%SERVICE_NAME%"
set APP_DESCRIPTION="сбор и передача данных по протоколу sftp с экпресс лабораторий"
